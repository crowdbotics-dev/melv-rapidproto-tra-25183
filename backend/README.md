...
## Project Structure
    ...
    ├── melv_rapidproto_tra_25183  # Django project configurations
...
1. Clone this repo and `cd melv_rapidproto_tra_25183`
...
2. Clone this repo and `cd melv_rapidproto_tra_25183`
